...
export PEER0_ORG3_CA=${PWD}/crypto-config/peerOrganizations/org3.halonetwork.com/peers/peer0.org3.halonetwork.com/tls/ca.crt
...
setGlobalsForPeer0Org3() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/crypto-config/peerOrganizations/org3.halonetwork.com/users/Admin@org3.halonetwork.com/msp
